...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-1.5 py-1 text-ui-xs font-medium text-ink-3 data-inset:pl-7",
        className
      )}
      {...props}
    />
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("-mx-1 my-1 h-px bg-rule/70", className)}
      {...props}
    />
  )
}
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-ui-xs tracking-widest text-ink-3 group-focus/dropdown-menu-item:text-ink",
        className
      )}
      {...props}
    />
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn("z-50 min-w-[96px] origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-md bg-paper-elevated p-1 text-ink shadow-[var(--shadow-popover)] ring-1 ring-rule-strong/55 duration-150 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 motion-reduce:animate-none", className )}
      {...props}
    />
  )
}
