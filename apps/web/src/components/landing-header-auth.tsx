...
export function LandingHeaderAuth() {
  ...
  if (isSignedIn) {
    return (
      <Button asChild size="sm" className="h-9 px-3.5 text-ui-sm">
  ...
  return (
    <>
      <Link
        href="/login"
        className="-mx-1 hidden h-9 items-center px-2 text-ui-sm font-medium text-ink-2 hover:text-ink sm:inline-flex"
      >
        {t("signIn")}
      </Link>
